/* =============================================================================
 * ТРЕНИРОВКИ ПАПА · АРТУР — ЕДИНСТВЕННЫЙ ФАЙЛ, КОТОРЫЙ ПРАВИТ АГЕНТ
 * =============================================================================
 *
 * Страница: trenirovka-papa.html (вёрстку и логику не трогать).
 *
 * Что менять:
...
var WORKOUTS = [
  {
    ...
    dateLabel: "черновик до анкеты · дома · коврик + гантели 3–5 кг + резинка по желанию",
    equipment: [
      { kind: "dumbbell", name: "гантели 3–5 кг", weightKg: 4 },
      { kind: "band", name: "резинка (по желанию)", weightKg: 8 },
    ...
    exercises: [
      {
        ...
        reps: "8",
        restSec: 75,
        gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Bodyweight-bodyweight-squat-front.mp4",
      ...
      },
      {
        ...
        reps: "6–8",
        restSec: 75,
        gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Bodyweight-incline-push-up-front.mp4",
      ...
      },
      {
        ...
        notes: "гантели 3–5 кг (черновик до анкеты); можно сидя на стуле со спинкой. Корпус спокойный, без прогиба в пояснице. Боль в плече — не поднимать выше комфорта или жать перед собой.",
        dumbbellKg: true
      },
      {
